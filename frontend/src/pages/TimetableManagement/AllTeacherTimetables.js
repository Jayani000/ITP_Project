...
function AllClassTimetables() {
    ...
    async function getTimetables() {
        await axios.get(`http://localhost:8070/TeacherTimetable/`).then((res) => {
    ...
    function handleSearch(event){
        ...
        axios.get(`http://localhost:8070/TeacherTimetable/`).then((res) => {
    ...
    return (
        <div className='container'>
            ...
            <div id="report" ref={componentRef}>
                <center>
                    <h1 className="text-light mb-5">Teacher Timetables</h1>
                </center>
                        ...
                        <div className="mb-5">
                            <div className='d-flex justify-content-between'>
                                ...
                                <div className="d-flex mt-4 h-25 justify-content-around">
                                    ...
                                    <Link to={`/TeacherTimetable/${timetable._id}`}>
                            ...
                            <table className="table table-dark">
                                ...
                                <tbody>
                                    ...
                                    {timetable?.classes.map((subject,index) => {
                                        return (
                                            <td key={index}>
                                                {index === 4 ? (
